		...
		<>
			...
			<section className="text-slide">
				<div class="text-slide-inner">
					...
					<p><Tween from={{ opacity: 0, y: -100 }} to={{ opacity: 1, y: 0, scrollTrigger: {trigger: '.pullout1', start: '-200px center', end: '200px center', scrub: 0.5, markers: true} }} ><div className="pullout right pullout1">
					...
					<p><Tween from={{ opacity: 0, y: -100 }} to={{ opacity: 1, y: 0, scrollTrigger: {trigger: '.pullout2', start: '-200px center', end: '200px center', scrub: 0.5, markers: true} }} ><div className="pullout left pullout2">
